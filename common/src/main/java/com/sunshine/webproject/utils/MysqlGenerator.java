...
public class MysqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return projectPath + "/"+PROJECT_NAME+"/src/main/resources/mapper/" + moduleName
        ...
        // 策略配置
        mpg.setStrategy(getStrategyConfig(moduleName));
        mpg.execute();
    }
    ...
    public static DataSourceConfig getDataSourceConfig(){
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/webproject?characterEncoding=UTF-8");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("sunshine1997");
        return dsc;
    }
    ...
    public static StrategyConfig getStrategyConfig(String moduleName){
